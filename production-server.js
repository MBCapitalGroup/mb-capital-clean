...
app.get('/api/team-members', (req, res) => {
  res.json([
    ...
    { id: 3, name: 'Dave Lindahl', title: 'Mentor', image: '/team-photos/dave-lindahl.jpg', bio: 'Dave Lindahl is a nationally renowned multifamily real estate investor, bestselling author, and respected mentor in the apartment syndication industry. With decades of hands-on experience acquiring, syndicating, and managing apartment communities, Dave has built a substantial multifamily portfolio and guided thousands of investors toward financial success.', hiddenFromWebsite: false, displayOrder: 3 },
