...
app.get('/api/team-members', (req, res) => {
  res.json([
    { id: 1, name: 'Michael Bachmann', title: 'Principal & Managing Partner', image: '/team-photos/michael-bachmann.jpg', bio: 'Real estate investment expert with 15+ years experience', hiddenFromWebsite: false, displayOrder: 1 },
    { id: 2, name: 'Makeba Hart', title: 'Asset Manager', image: '/team-photos/makeba-hart.jpg', bio: 'Experienced asset manager specializing in multifamily properties', hiddenFromWebsite: false, displayOrder: 2 }
  ]);
});
