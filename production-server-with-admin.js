...
const adminUsers = {
    'admin': 'Scrappy2025Bachmann##',
    'Testadmin': 'MakebaRocks123'
};
...
// API Routes - Complete 8-person team with CACHE-BUSTING PHOTO URLS
app.get('/api/team-members', (req, res) => {
  const cacheBuster = Date.now(); // Force browser to reload images
  res.json([
    {
      id: 1,
      ...
      image: `/team-photos/Michael%20Bachmann.jpg?v=${cacheBuster}`,
      displayOrder: 1,
    ...
    },
    {
      ...
      image: `/team-photos/makeba_hart.jpg?v=${cacheBuster}`,
      displayOrder: 2,
      hiddenFromWebsite: false
    },
    {
      ...
      image: `/team-photos/Dave-Lindahl.jpg?v=${cacheBuster}`,
      displayOrder: 3,
      hiddenFromWebsite: false
    },
    {
      ...
      image: `/team-photos/Dean-Graziosi.jpg?v=${cacheBuster}`,
      displayOrder: 4,
      hiddenFromWebsite: false
    },
    {
      ...
      image: `/team-photos/Tom_krol.jpg?v=${cacheBuster}`,
      displayOrder: 5,
      hiddenFromWebsite: false
    },
    {
      ...
      image: `/team-photos/Eric_stewart.jpg?v=${cacheBuster}`,
      displayOrder: 6,
      hiddenFromWebsite: false
    },
    {
      ...
      image: `/team-photos/Jeannie_orlowski.jpg?v=${cacheBuster}`,
      displayOrder: 7,
      hiddenFromWebsite: false
    },
    {
      ...
      image: `/team-photos/Scott.jpg?v=${cacheBuster}`,
      displayOrder: 8,
      hiddenFromWebsite: false
    }
  ]);
