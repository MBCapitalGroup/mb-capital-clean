...
app.get('/api/team-members', (req, res) => {
  res.json([
    ...
    { id: 4, name: 'Scott Stafford', title: 'Demographer', imageUrl: '/team-photos/dave-lindahl-solo.jpg', bio: 'Scott Stafford brings deep expertise in demographic analysis and market research to MB Capital Group, where he plays a critical role in identifying high-potential multifamily investment opportunities. His background in data analytics and economic modeling allows the team to make informed decisions rooted in future-facing market intelligence.', hiddenFromWebsite: false, displayOrder: 4 },
